...
PARKING_DIR = os.environ.get("OKAYAMA_PARKING_ROOT", os.path.join(PROJECT_ROOT, "99_sonota", "00_parking"))

GTFS_DIR    = os.environ.get("OKAYAMA_GTFS_ROOT", os.path.join(PROJECT_ROOT, "_local_data", "0kayama_GTFS"))
