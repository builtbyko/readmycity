...
if os.name == "nt":
    ...
    PARKING_ROOT    = os.environ.get("OKAYAMA_PARKING_ROOT", os.path.join(PROJECT_ROOT, "99_sonota", "00_parking"))
    GTFS_ROOT       = os.environ.get("OKAYAMA_GTFS_ROOT", os.path.join(PROJECT_ROOT, "_local_data", "0kayama_GTFS"))
    PARKING_GEOJSON = os.path.join(PARKING_ROOT, "parking.geojson")
    PARKING_PLATEAU = os.path.join(PARKING_ROOT, "parking_plateau.geojson")
    GTFS_OKADEN     = os.path.join(GTFS_ROOT, "okaden")
    GTFS_RYOBI      = os.path.join(GTFS_ROOT, "ryobi")
    JINRYU_CSV      = os.environ.get("OKAYAMA_JINRYU_CSV", os.path.join(PROJECT_ROOT, "_local_data", "zinryu_okayama", "kobetsuarea_time.csv"))
else:
    SCRIPT_DIR      = os.path.dirname(os.path.abspath(__file__))
    PROJECT_ROOT    = os.path.abspath(os.path.join(SCRIPT_DIR, "..", ".."))
    PARKING_ROOT    = os.environ.get("OKAYAMA_PARKING_ROOT", os.path.join(PROJECT_ROOT, "99_sonota", "00_parking"))
